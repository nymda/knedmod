...
void sigscanItems() {
    ...
    glb::oDamagePlayer = (damagePlayer)mem::FindPattern((PBYTE)"\xF3\x0F\x10\x91\x54\x01\x00\x00\x0F\x57\xC0\xF3\x0F\x5C\xD1\xF3", "xxxxxxxxxxxxxxxx", GetModuleHandle(NULL));
